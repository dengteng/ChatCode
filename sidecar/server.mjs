...
const COMMIT_SUMMARY_INSTRUCTION =
  ...
  "小结只写这轮改了什么/产出了什么,不要提补测试、跑测试、测试通过、打包、构建、格式化、lint 这类标准流程动作 —— " +
  "它们是每轮都做的 SOP,写进去等于没信息。整轮只做了这些 SOP 而无实质改动时,不输出小结行。";
...
function stripForLog(msg) {
  const m = capToolResults(externalizeImages(msg)); // 见 logcap.mjs:tool_result 正文占了老日志四分之三体积

...
// 中文编号清单:每条各自成行(顿号编号不带空格,老 regex 认不出,长条目会把下一条吸上来)
eq(u("二、截屏录屏\n1、截图/录屏：画笔、马赛克、高亮、加文字、提取文字、解析二维码、长截图\n2、录屏：可录制mp4和gif格式\n3、剪贴板管理"),
   "二、截屏录屏\n1、截图/录屏：画笔、马赛克、高亮、加文字、提取文字、解析二维码、长截图\n2、录屏：可录制mp4和gif格式\n3、剪贴板管理", "中文顿号编号不并");
// 括号编号 / 带圈数字同理
eq(u("（1）第一条写得很长很长很长很长很长很长很长很长很长很长很长很长很长\n（2）第二条\n①第三条"),
   "（1）第一条写得很长很长很长很长很长很长很长很长很长很长很长很长很长\n（2）第二条\n①第三条", "括号与带圈编号不并");
// 但编号条目自己的续行(不带编号)照旧要并回去
eq(u("1、这一条长到把窄栏顶满了这一条长到把窄栏顶满了这一条长到把栏顶满\n它被截下来的续行"),
   "1、这一条长到把窄栏顶满了这一条长到把窄栏顶满了这一条长到把栏顶满它被截下来的续行", "编号条目的续行照并");
